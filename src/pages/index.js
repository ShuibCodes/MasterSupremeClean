	...
	return (
		<>
			<Helmet>
				...
				<meta name="twitter:title" content="Master Supreme Clean" />
				<meta name="twitter:image" content={cleaner} />

				<meta property="og:title" content="Master Supreme Clean" />
				<meta property="og:image" content={cleaner} />
			</Helmet>
					...
					<div className="mx-auto  max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
						<div className="px-4 lg:-mt-12 lg:w-1/2 sm:px-8 xl:pr-16">
							...
							<p className="mt-3 max-w-md mx-auto text-lg text-sm text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl ">
								Struggling to find the time to clean up? We've got you covered.
								<span>
									{' '}
									From one-off deep cleans to 6-month contracts, we have a range of packages to choose
									from.
								</span>
							</p>
